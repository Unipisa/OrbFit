c ==============MODULE time_scales===================
c TIME AND TIMESCALES: Carpino 1996-1998
c CONTAINS
c SUBROUTINES
c 
c *ch2tim	translation of a character string into time value
c *intmon	transform a 3-letter code of a month into integer
c tjm1		computation of Modified Julian Date
c mjddat        transformation of Modified Julian Date to calendar date
c timnf		reduction of time (MJD+sec) to normal form
c itaiut        difference DAT = TAI - UTC as a function of UTC
c chktsc	check existence of a time scale
c cnvtim	conversion between different time scales
c deltt		difference DT = ET - UT
c chmon		transforms integer month (1-12) into a 3-letter code
c bessep	Besselian epoch as a function of MJD
c chmo2i	transforms 3-character month names into integer
c julian        calendar to julian date
c
c times         barycentric to terrestrial time (for rrdot only)  
c
c
...
c=========================================================
c this is used only for rrdot
c
      SUBROUTINE TIMES (TDBJD,TTJD,SECDIF)
C
C     THIS ROUTINE COMPUTES THE TERRESTRIAL TIME (TT) JULIAN DATE
