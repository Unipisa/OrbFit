...
distribution: distclean notar
	tar -cvf ../OrbFit3.3.2.tar -X notar . ; \
	gzip ../OrbFit3.3.2.tar
...
nondistribute: 
	...
	tar -T notar -cvf ../OrbFitwork332.tar ; gzip ../OrbFitwork332.tar
...
patch: 
	tar -T patchlist -cvf ../patch3.3.3.tar ; gzip ../patch3.3.3.tar
