!     ******************************************************************
!     ************** CHANGE to MUTUAL REFERENCE SYSTEM *****************
!     ******************************************************************
...
!     COMPUTE ANGLE BETWEEN N1,N2                                       
      ...
      ELSEIF (test.lt.0.d0) THEN 
         sinI = -sinI 
      ELSE 
         WRITE(*,*)'mutualrefcha: ERROR! sinI=',sinI 
      ENDIF 
...
!     COMPUTE ANGLE BETWEEN ASCMN,xpl0                                  
      ...
      ELSEIF (test.lt.0.d0) THEN 
         sinompl = -sinompl 
      ELSE 
         WRITE(*,*)'mutualrefcha: ERROR! sinompl=',sinompl 
      ENDIF 
...
!     COMPUTE ANGLE BETWEEN ASCMN,x0                                    
      ...
      ELSEIF (test.lt.0.d0) THEN 
         sinom = -sinom 
      ELSE 
         WRITE(*,*)'mutualrefcha: ERROR! sinom=',sinom 
      ENDIF 
...
!     ==================================================================
        ...
        beta = dsqrt(1.d0-e**2) 
        if(abs(1.d0-e**2).le.1.d-10) then 
           beta = 0.d0
        elseif(1.d0-e**2.gt.1.d-10) then                       
           beta = dsqrt(1.d0-e**2) 
        else
           write(*,*)'mutualrefcha: error! imaginary value for beta',1.d0-e**2 
           beta=0.d0
        endif
