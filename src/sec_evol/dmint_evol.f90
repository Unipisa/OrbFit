...
! ------ INPUT ORBITAL EVOLUTION --------
 ...
 ! ------- DMINTIL SECULAR EVOLUTION ------
  ...
  INTEGER,PARAMETER :: nstep=300 ! number of time steps
...
!           CALL dmintil_rms(evolpla(3,i),elem,nummin,dmintil)
        ENDIF
! assign dummy values, to write output file
        ...
        ELSE
           WRITE(iunmoid,106) (elem%t-tast0)/365.25d0,nummin,dmintil(1:2)
        ENDIF
