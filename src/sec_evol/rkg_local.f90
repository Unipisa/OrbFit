...
! ****************************************************************** 
!    write(*,*)t1,t,y,h,a
    CALL prrkg(tast0,t,y,h,yat,aa,isrk,lit,yi,ck,eprk,nit) 
...
! INPUT
    ...
    REAL(KIND=dkind),INTENT(IN) :: y(4) !y(1)=omega,y(2)=G,y(3)=Omega,y(4)=zl
! OUTPUT
    REAL(KIND=dkind),INTENT(OUT) :: yat(4) ! yat is y vector at time t+h
    INTEGER,INTENT(IN) :: isrk,lit
    INTEGER,INTENT(INOUT) :: nit ! nit is the number of iterations
    REAL(KIND=dkind),INTENT(INOUT) :: yi(4,ismax),ck(ismax,4)
! ======================= END INTERFACE ============================
    REAL(KIND=dkind) :: dery(4),de
...
! per i loop(forse non servono)
    ...
    INTEGER :: fail_flag
! ===================== right hand side ============================
    REAL(KIND=dkind) :: om,g,omnod,zl,ddd(4),eee(4) 
    INTEGER :: nnn(4)
! ==================================================================
! dn,dnod                                                           
...
!             el_pla(n)%t=t_int(j)
          ...
          CALL chooserhs(y,om,omnod,g,zl,aa,ddd,eee,nnn)
          dery(1)=-ddd(1) 
          dery(2)=ddd(2) 
          dery(3)=-ddd(3)
          dery(4)=ddd(4) 
