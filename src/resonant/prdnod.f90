...
! ======================= END INTERFACE ============================
 REAL(KIND=dkind) :: e,dnp,dnm,tmp,adn,a
 INTEGER :: i
 ...
 INTEGER :: fail_flag
! *****************************************************************
! Compute asteroid eccentricity and semimajor axis
 a=(y(5)/ky)**2.d0
...
! ******************************************************************
SUBROUTINE prddnod(y,dy,dn,ddn,nnod)
  USE fund_const
  USE orbit_elements
  USE planet_orbits
!  USE critical_points
...
! a= semimajor axis (au)
  REAL(KIND=dkind),INTENT(IN) :: y(6),dy(6)
! =========================== OUTPUT ==============================
! dn= 2 x npl nodal distances
