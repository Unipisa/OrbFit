...
! end interface -----------------------------------------
  ...
  REAL(KIND=dkind) :: averaged_rhs(6) 
...
! ------------------------------------------------------
     CALL rhs2(j,elpl(j),n_res,elem%coord(5),elem%coord(4),G,zl, &
          & elem%coord(1),elem%coord(6),ddd,eee,nnn)
!  write(*,*)'ddd',ddd
