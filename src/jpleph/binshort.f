C                                                                               
C   binshort : a program to shorten a binary JPL Ephemeris file                 
C                                                                               
C   NOTE that the user must set a few parameters                                
C                                                                               
...
c  *****  SET the start and stop times (JED) of new file  *****                 
c
...
C                                                                               
      IMPLICIT double precision (A-H,O-Z)                                       
C                                                                               
C       CONVERTS JULIAN DAY NUMBER TO CALENDAR DATE                             
C     IDATE(6)=MONTH,DAY,YEAR,HOUR,MINUTE,SECOND (INTEGER) FOR CALENDAR DATE    
C     DJED=DOUBLE PRECISION JULIAN DAY NUMBER TO BE INPUT                       
C     FLAG=(-1,0,+1(=)JULIAN,AUTOMATIC,GREGORIAN) CALENDAR DATE OUTPUT          
C       AUTOMATIC MODE SELECTS JULIAN CALENDAR FOR DAYS ON AND BEFORE           
C       DJED=2299160=1582OCT4, GREGORIAN AFTER THIS DATE = 1582OCT15.           
C       OTHER MODES EMPLOY CALENDAR INDICATED.                                  
C     **RESTRICTIONS - INPUT JULIAN CALENDAR MUST BE FOR A POSITIVE JULI        
C       DAY NUMBER.  FOR GREGORIAN CALENDAR, DJED.GT.1721119 (DATES A.D.)       
C     **SEE SUBROUTINE CTOJ FOR INVERSE FUNCTIONS AND REFERENCES TO             
C       CALENDAR DEFINITIONS, TO BE FOUND IN EXP.SUPP. PP.412, 436.             
C                                                                               
